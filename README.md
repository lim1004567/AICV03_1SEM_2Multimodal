...
<img width="1138" height="638" alt="image" src="https://github.com/user-attachments/assets/d6249063-415d-44a7-93c5-ca24eb606378" />
...
| **항목** | **스승 (Layer 4)** | **학생 (Layer 2)** | **평가** |
| --- | --- | --- | --- |
| **Test F1** | 0.9231 | **0.9057** | **최상 (성능 유지 우수)** |
| **Test RMSE** | 0.3468 | **0.3638** | **우수 (오차범위 미미)** |
| **모델 규모** | 873,541 | **476,997** | **약 45% 경량화 성공** |


📊 [CUDA] 경량화 모델 추론 속도 리포트

스승 모델 Latency : 2.14 ms
학생 모델 Latency : 1.50 ms
지연시간 단축 : 29.9% 감소
추론 속도 향상 : 1.43배 빨라짐
실시간 처리 (FPS) : 666.54 frames/sec

📊 [CPU] 경량화 모델 추론 속도 리포트

스승 모델 Latency : 5.42 ms
학생 모델 Latency : 3.07 ms
지연시간 단축 : 43.4% 감소
추론 속도 향상 : 1.77배 빨라짐
실시간 처리 (FPS) : 325.81 frames/sec
